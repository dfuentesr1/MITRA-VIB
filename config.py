...
class TrainConfig:
    def __init__(self):
        self.algorithm = "MITRAVIB"
        self.total_timesteps = 13e6
        self.step_num = 10
...
class StationSetConfig:
    def __init__(self):
        self.es_cs_num = 3
        self.user_device_num = 7
        self.time_step_max = 1

        self.es_cs_config = StationConfig()
        self.user_device_config = UserDeviceConfig()
        self.task_config = TaskConfig()


class StationConfig:
    def __init__(self):
        self.es_cs_computing_ability = 6.0
        self.es_cs_computing_ability_list = [10.0, 19.0, 26.0]
        self.es_cs_computing_ability_eval = 8.8
        self.es_cs_computing_ability_eval_list = [8.6]
        self.es_cs_computing_ability_max = 25.0
        self.es_cs_computing_ability_eval_max = 18
        self.es_cs_energy = 200.0
        self.es_cs_height = 20.0
        self.task_queue_size_max = 100


class UserDeviceConfig:
    def __init__(self):
        self.user_device_ability = 1.0
        self.user_device_ability_max = 3.0
        self.queue_time = 0.0
        self.transmitting_time_to_all_es_cs_array = np.array([
            [0.3011, 0.303, 0.302],
            [0.3021, 0.302, 0.301],
            [0.3031, 0.301, 0.302],
            [0.3021, 0.302, 0.303],
        ...
        self.transmitting_time_to_es_cs_max = 0.5
...
class TaskConfig:
    def __init__(self):
        ...
        self.task_switch_time_matrix_on_es_cs = np.array([
            [0.101, 0.102, 0.103],
            [0.103, 0.104, 0.102],
            [0.105, 0.106, 0.104],
            [0.101, 0.102, 0.103],
...
class GlobalConfig:
    def __init__(self):
        ...
        self.es_cs_set_config = StationSetConfig()
